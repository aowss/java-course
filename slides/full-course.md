...
<aside class="link-box slide-footer further-reading"><span class="footer-label">Quizzes</span><span class="footer-links">Quizzes for a given chapter can be accessed from the Examples slide. To return to the course slide, use your browser ←.</span></aside>
