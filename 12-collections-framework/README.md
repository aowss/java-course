...
| File                                                                               | Demonstrates                              |
|------------------------------------------------------------------------------------|-------------------------------------------|
| [`ListOperations.java`](src/main/java/course/ch12/examples/ListOperations.java)    | `ArrayList`, sorting, reversing           |
| [`SetOperations.java`](src/main/java/course/ch12/examples/SetOperations.java)      | `HashSet`, `TreeSet`, uniqueness          |
| [`MapOperations.java`](src/main/java/course/ch12/examples/MapOperations.java)      | `HashMap`, `TreeMap`, key-value ops       |
| [`QueueDemo.java`](src/main/java/course/ch12/examples/QueueDemo.java)              | `ArrayDeque`, FIFO and LIFO               |

## Exercises

### Exercise 1: Frequency Counter (Guided)

**File:** [`FrequencyCounter.java`](src/main/java/course/ch12/exercises/FrequencyCounter.java)

Count word frequencies in text using a `HashMap`. Return results sorted by frequency.

```bash
mvn test -pl 11-collections-framework -Dtest="FrequencyCounterTest"
```

### Exercise 2: Unique Queue (Practice)

**File:** [`UniqueQueue.java`](src/main/java/course/ch12/exercises/UniqueQueue.java)

Build a FIFO queue that rejects duplicate elements.

```bash
mvn test -pl 11-collections-framework -Dtest="UniqueQueueTest"
```

### Exercise 3: LRU Cache (Challenge)

**File:** [`LRUCache.java`](src/main/java/course/ch12/exercises/LRUCache.java)

Implement a least-recently-used cache with fixed capacity using `LinkedHashMap`.

```bash
mvn test -pl 11-collections-framework -Dtest="LRUCacheTest"
```
...
- Collections are not thread-safe unless explicitly designed for concurrency (Chapter 18).
