...
| File                                                                                  | Demonstrates                                                |
|---------------------------------------------------------------------------------------|-------------------------------------------------------------|
| [`StringImmutability.java`](src/main/java/course/ch09/examples/StringImmutability.java) | Immutability, interning, common String methods              |
| [`TextBlockDemo.java`](src/main/java/course/ch09/examples/TextBlockDemo.java)          | Text blocks, String.format(), formatted()                   |
| [`RegexBasics.java`](src/main/java/course/ch09/examples/RegexBasics.java)              | Pattern, Matcher, findAll, replaceAll, capture groups       |

## Exercises

### Exercise 1: Word Counter (Guided)

**File:** [`WordCounter.java`](src/main/java/course/ch09/exercises/WordCounter.java)
...
```bash
mvn test -Dtest="course.ch09.exercises.WordCounterTest"
```

### Exercise 2: Template Engine (Practice)

**File:** [`TemplateEngine.java`](src/main/java/course/ch09/exercises/TemplateEngine.java)
...
```bash
mvn test -Dtest="course.ch09.exercises.TemplateEngineTest"
```

### Exercise 3: Markdown to HTML (Challenge)

**File:** [`MarkdownToHtml.java`](src/main/java/course/ch09/exercises/MarkdownToHtml.java)
...
```bash
mvn test -Dtest="course.ch09.exercises.MarkdownToHtmlTest"
```
