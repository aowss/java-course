...
| File                                                                                     | Demonstrates                          |
|------------------------------------------------------------------------------------------|---------------------------------------|
| [`LambdaBasics.java`](src/main/java/course/ch11/examples/LambdaBasics.java)              | Comparator lambdas, Runnable          |
| [`MethodReferenceDemo.java`](src/main/java/course/ch11/examples/MethodReferenceDemo.java)| All four method reference forms       |
| [`FunctionComposition.java`](src/main/java/course/ch11/examples/FunctionComposition.java)| andThen, compose, predicate chaining  |

## Exercises

### Exercise 1: String Filters (Guided)

**File:** [`StringFilters.java`](src/main/java/course/ch11/exercises/StringFilters.java)

Build `Predicate<String>` factories and a filter method.

```bash
mvn test -pl 11-functional-programming -Dtest="StringFiltersTest"
```

### Exercise 2: Pipeline (Practice)

**File:** [`Pipeline.java`](src/main/java/course/ch11/exercises/Pipeline.java)

Chain `Function<T, T>` transformations in a fluent builder.

```bash
mvn test -pl 11-functional-programming -Dtest="PipelineTest"
```

### Exercise 3: Event Bus (Challenge)

**File:** [`EventBus.java`](src/main/java/course/ch11/exercises/EventBus.java)

Register listeners by event type and publish events to matching consumers.

```bash
mvn test -pl 11-functional-programming -Dtest="EventBusTest"
```
...
- Lambdas are the foundation of the Streams API (Chapter 12).
