...
| File                                                                                       | Demonstrates                                           |
|--------------------------------------------------------------------------------------------|--------------------------------------------------------|
| [`FileReadWrite.java`](src/main/java/course/ch15/examples/FileReadWrite.java)              | NIO.2 Files API: write, read, append, readAllLines     |
| [`DirectoryWalker.java`](src/main/java/course/ch15/examples/DirectoryWalker.java)          | Walking directory trees, filtering, calculating sizes  |
| [`ByteStreamDemo.java`](src/main/java/course/ch15/examples/ByteStreamDemo.java)            | Byte-oriented I/O with streams and Files convenience   |

## Exercises

### Exercise 1: Line Counter (Guided)

**File:** [`LineCounter.java`](src/main/java/course/ch15/exercises/LineCounter.java)
...
```bash
mvn test -Dtest="course.ch15.exercises.LineCounterTest"
```

### Exercise 2: File Search (Practice)

**File:** [`FileSearch.java`](src/main/java/course/ch15/exercises/FileSearch.java)
...
```bash
mvn test -Dtest="course.ch15.exercises.FileSearchTest"
```

### Exercise 3: CSV Parser (Challenge)

**File:** [`CsvParser.java`](src/main/java/course/ch15/exercises/CsvParser.java)
...
```bash
mvn test -Dtest="course.ch15.exercises.CsvParserTest"
```
