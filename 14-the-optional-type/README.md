...
| File                                                                                        | Demonstrates                                           |
|---------------------------------------------------------------------------------------------|--------------------------------------------------------|
| [`OptionalCreation.java`](src/main/java/course/ch14/examples/OptionalCreation.java)         | `of`, `ofNullable`, `empty`, unwrapping methods        |
| [`OptionalChaining.java`](src/main/java/course/ch14/examples/OptionalChaining.java)         | `map`, `flatMap`, `filter`, chaining pipelines         |
| [`OptionalAntiPatterns.java`](src/main/java/course/ch14/examples/OptionalAntiPatterns.java) | Common mistakes and their correct alternatives         |

## Exercises

### Exercise 1: Safe Parser (Guided)

**File:** [`SafeParser.java`](src/main/java/course/ch14/exercises/SafeParser.java)
...
```bash
mvn test -Dtest="course.ch14.exercises.SafeParserTest"
```

### Exercise 2: User Service (Practice)

**File:** [`UserService.java`](src/main/java/course/ch14/exercises/UserService.java)
...
```bash
mvn test -Dtest="course.ch14.exercises.UserServiceTest"
```

### Exercise 3: Config Reader (Challenge)

**File:** [`ConfigReader.java`](src/main/java/course/ch14/exercises/ConfigReader.java)
...
```bash
mvn test -Dtest="course.ch14.exercises.ConfigReaderTest"
```
