...
| File                                                                                    | Demonstrates                                           |
|-----------------------------------------------------------------------------------------|--------------------------------------------------------|
| [`StreamCreation.java`](src/main/java/course/ch14/examples/StreamCreation.java)         | Creating streams from collections, arrays, ranges, generators |
| [`IntermediateOps.java`](src/main/java/course/ch14/examples/IntermediateOps.java)       | `filter`, `map`, `flatMap`, `distinct`, `sorted`, `limit` |
| [`TerminalOps.java`](src/main/java/course/ch14/examples/TerminalOps.java)               | `reduce`, `collect`, `count`, `min`/`max`, `findFirst` |
| [`CollectorExamples.java`](src/main/java/course/ch14/examples/CollectorExamples.java)     | `groupingBy`, `partitioningBy`, `joining`, statistics  |

## Exercises

### Exercise 1: Stream Exercises (Guided)

**File:** [`StreamExercises.java`](src/main/java/course/ch14/exercises/StreamExercises.java)
...
```bash
mvn test -Dtest="course.ch14.exercises.StreamExercisesTest"
```

### Exercise 2: Text Analyzer (Practice)

**File:** [`TextAnalyzer.java`](src/main/java/course/ch14/exercises/TextAnalyzer.java)
...
```bash
mvn test -Dtest="course.ch14.exercises.TextAnalyzerTest"
```

### Exercise 3: Transaction Report (Challenge)

**File:** [`TransactionReport.java`](src/main/java/course/ch14/exercises/TransactionReport.java)
...
```bash
mvn test -Dtest="course.ch14.exercises.TransactionReportTest"
```
