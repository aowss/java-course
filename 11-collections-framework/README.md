...
| File                                                                               | Demonstrates                              |
|------------------------------------------------------------------------------------|-------------------------------------------|
| [`ListOperations.java`](src/main/java/course/ch11/examples/ListOperations.java)    | `ArrayList`, sorting, reversing           |
| [`SetOperations.java`](src/main/java/course/ch11/examples/SetOperations.java)      | `HashSet`, `TreeSet`, uniqueness          |
| [`MapOperations.java`](src/main/java/course/ch11/examples/MapOperations.java)      | `HashMap`, `TreeMap`, key-value ops       |
| [`QueueDemo.java`](src/main/java/course/ch11/examples/QueueDemo.java)              | `ArrayDeque`, FIFO and LIFO               |

## Exercises

### Exercise 1: Frequency Counter (Guided)

**File:** [`FrequencyCounter.java`](src/main/java/course/ch11/exercises/FrequencyCounter.java)
...
**File:** [`UniqueQueue.java`](src/main/java/course/ch11/exercises/UniqueQueue.java)
...
**File:** [`LRUCache.java`](src/main/java/course/ch11/exercises/LRUCache.java)
...
- Use streams (Chapter 13) for declarative collection processing.
